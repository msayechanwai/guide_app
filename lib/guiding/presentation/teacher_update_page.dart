...
class _TeacherEditPageState extends ConsumerState<TeacherEditPage> {
  ...
  void initState() {
    ...
    // Ensure teacherId is not null or empty
    if (widget.teacher.id == null || widget.teacher.id.isEmpty) {
      print("Error: teacherId is null or empty");
    }
  }
              ...
              ElevatedButton(
                onPressed: () {
                  TeacherModel teacher = TeacherModel(
                    ...
                    id: widget.teacher.id, // Ensure this is not null or empty
                  );
                  print("Updating teacher with data: ${teacher}");
